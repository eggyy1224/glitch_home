...
vi.mock("@react-spring/three", () => ({
  __esModule: true,
  a: {
    mesh: ({ children, ...rest }: { children?: React.ReactNode } & Record<string, any>) => (
      <mesh data-testid="animated-mesh" {...rest}>{children}</mesh>
    ),
    meshBasicMaterial: ({ children, ...rest }: { children?: React.ReactNode } & Record<string, any>) => (
...
vi.mock("../../../src/components/kinship/scene/utils/graph", () => ({
  __esModule: true,
  buildLineageGraph: (...args: Parameters<typeof buildLineageGraphMock>) => buildLineageGraphMock(...args),
}));

vi.mock("../../../src/components/kinship/scene/utils/layouts", () => ({
  __esModule: true,
  createIncubatorLayout: (...args: Parameters<typeof createIncubatorLayoutMock>) => createIncubatorLayoutMock(...args),
  createIncubatorEdges: (...args: Parameters<typeof createIncubatorEdgesMock>) => createIncubatorEdgesMock(...args),
}));
