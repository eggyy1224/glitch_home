...
import KinshipScene from "../../../src/components/kinship/KinshipScene.jsx";
import {
  KINSHIP_MODE_CONFIGS,
  KinshipModes,
  selectKinshipMode,
} from "../../../src/components/kinship/hooks/useKinshipModeSelection.js";
...
vi.mock("../../../src/components/kinship/scene/modes/PhylogenyScene.jsx", () => ({
  __esModule: true,
  default: PhylogenySceneMock,
}));

vi.mock("../../../src/components/kinship/scene/modes/IncubatorScene.jsx", () => ({
  __esModule: true,
  default: IncubatorSceneMock,
}));

vi.mock("../../../src/components/kinship/scene/components/SceneClusters.jsx", () => ({
  __esModule: true,
  default: SceneClustersMock,
}));

vi.mock("../../../src/components/kinship/hooks/useKinshipCapture.js", () => ({
